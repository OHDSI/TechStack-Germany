...
-- based on https://github.com/OHDSI/CommonDataModel/blob/main/inst/ddl/5.3/postgresql/OMOPCDM_postgresql_5.3_ddl.sql f39870c
-- extended by serial IDs

SET search_path TO cds_cdm;
...
CREATE TABLE visit_detail (
			visit_detail_id serial NOT NULL,
			person_id integer NOT NULL,
